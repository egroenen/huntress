export const BrandMark = () => {
  return (
    ...
    >
      <defs>
        <linearGradient id="huntress-brand-lens" x1="0%" x2="100%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#5ad5ef" />
          <stop offset="100%" stopColor="#1786b3" />
        </linearGradient>
        <linearGradient id="huntress-brand-core" x1="0%" x2="100%" y1="0%" y2="100%">
      ...
      <circle
        ...
        r="18"
        fill="none"
        stroke="url(#huntress-brand-lens)"
        strokeWidth="7"
      />
      <path
        d="M40.5 40.5L53 53"
